...
class PGD():
    ...
    def perturb(self, original_images, labels, epoch,random_start=False):
        ...
        with torch.enable_grad():
            for _iter in range(self.max_iters):
                outputs, outputs_r, outputs_nr, outputs_rec,evidence_b,tmc_loss = self.model(x,labels,epoch,True)
