...
class WideResNet(nn.Module):
    def __init__(self, depth=34, num_classes=10, widen_factor=10, dropRate=0.0, tau=0.1, image_size=(32, 32),args=None):
...
def WideResNet34_trobust(num_classes=10, tau=0.1, image_size=(32, 32),args=None):
    return WideResNet(num_classes=num_classes, tau=tau, image_size=image_size,args=args)
